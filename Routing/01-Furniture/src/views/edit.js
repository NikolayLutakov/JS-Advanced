...
export function editPage(ctx) {
    ...
    renderView(furniturePromise, null, {});

    function renderView(furniturePromise, errorMsg, errors){
        ctx.render(editTemplate(loadFurniture(furniturePromise, errorMsg, errors)));
    }

    async function loadFurniture(furniturePromise, errorMsg, errors){
        const furniture = await furniturePromise;
    
        return formTemplate(furniture, onSubmit, errorMsg, errors);
    }
    ...
    async function onSubmit(event){
        ...
        try {
            ...
            renderView(data, message, err.errors || {});
        }
    }
}
